...
function removeFirstOccurrences(str, value) {
    var startPos = str.indexOf(value);
...
function encodeToRot13(str) {
  function valueROT13(n) {
    if ((n >= "A".charCodeAt(0) && n <= "Z".charCodeAt(0)) || (n >= "a".charCodeAt(0) && n <= "z".charCodeAt(0))) {
      if (n > ("Z".charCodeAt(0) - 13) && n <= "Z".charCodeAt(0) || n > ("z".charCodeAt(0) - 13)) return n - 13;
      return n + 13;
    } else {
      return n;
    }
  ...
  let newArr = arr.map(function(item) {
    return String.fromCharCode(valueROT13(item.charCodeAt(0)))
  });
  return newArr.join("");
}
